...
export const MeasureDetailCard = ({
  ...
  return (
    <Card className="bg-card relative flex flex-col gap-y-4 p-4">
          ...
          <>
            {measuresCount > 1 && (
              ...
              >
                <span>
                  {trend! < -10 ? (
                    <MoveDownIcon className="mr-1 size-4" />
                  ) : trend! < 0 && trend! >= -10 ? (
                    <MoveDownRightIcon className="mr-1 size-4" />
                  ) : trend! === 0 ? (
                    <MoveRightIcon className="mr-1 size-4" />
                  ) : trend! > 0 && trend! <= 10 ? (
                    <MoveUpRightIcon className="mr-1 size-4" />
                  ) : trend! > 10 ? (
                    <MoveUpIcon className="mr-1 size-4" />
                  ) : (
                    ""
                  )}
                </span>
